...
namespace Dungeon.AgentLowLevelSystem
{
    public partial class AgentLowLevelSystem : MonoBehaviour, IAgentLowLevelSystem
    {
        ...
        public DndCheckResult DndCheck(DndCheckTarget target) => m_DndSystem.DNDCheck(this,target);
    ...
    public class DndSystem
    {
        ...
        public DndCheckResult DNDCheck(AgentLowLevelSystem checker, DndCheckTarget target)
        {
    ...
    public struct DndCheckResult
    {
        ...
        public int Total { get; private set; }  // 总检定值 (RollResult + 修正值)
        public readonly bool Success { get => Total >= Target.DifficultyClass; }  // 是否成功
