...
{
    public class UseSkillActionTideAction : GoapActionBase<ActionDataForSkillUsage>
    {
        ...
        {
            agent.LowLevelSystem.UseSkill(new SkillDesc("Action Tide"),data.DirectionToUseSkill);
