...
{
    public class UseSkillBattleShoutAction : GoapActionBase<ActionDataForSkillUsage>
    {
        ...
        {
            agent.LowLevelSystem.UseSkill(new SkillDesc("Battle Shout"),data.DirectionToUseSkill);
